                      ...
                      <div className="flex items-center gap-1">
                        <button
                          onClick={(e) => {
                            ...
                            setDetailSubTab('executive');
                          }}
                          className="px-2 py-0.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded font-bold hover:text-indigo-600 transition-colors"
                        >
                          Summary
                        </button>
                        <button
                        ...
                        <button
                          ...
                          className="px-2 py-0.5 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 rounded font-bold transition-colors flex items-center gap-0.5"
                        >
